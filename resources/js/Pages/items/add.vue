    ...
    <div class="p-4 flex flex-col gap-4">
        ...
        <form @submit.prevent="forms.post(route('items.store'))" enctype="multipart/form-data" class="bg-white p-4 rounded-sm flex flex-col gap-4" method="POST">
            <div class="w-max">
                ...
                <label for="image" v-else class="cursor-pointer rounded-sm w-48 h-48 aspect-square object-cover object-center bg-primary/15 flex justify-center items-center">
                    <i class="bx bx-image text-5xl"></i>
                </label>
                <input accept=".jpg,.jpeg,.png,.webp" hidden type="file" name="image" id="image" @change="e => forms.image = e.currentTarget!.files[0]">
            </div>
            <div>
                <p>Name</p>
            ...
            <div class="flex justify-between">
                ...
                <button class="bg-primary py-2 text-sm px-4 w-16 flex justify-center items-center" type="submit" :disabled="forms.processing">
